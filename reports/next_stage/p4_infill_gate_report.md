...
- Candidate coverage after latent/transition + probability + actual-decoding checks: 0.960
- Cross-entropy gain over uniform: 3.4189 nats
- Max-edit B pooled/macro/min-device retention: 1.000 / 1.000 / 1.000
- Infill peak/derivative p95 improvement over full-codebook random diagnostic: 0.919 / 0.919
- Failed checks: `none`
